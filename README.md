...
```text
	...
	Added com.symbol.emdk.emdkservice to the query element of the AndroidManifest.xml
	Added com.zebra.zebracontentprovider to the query element of the AndroidManifest.xml
	API updated to 33
```
