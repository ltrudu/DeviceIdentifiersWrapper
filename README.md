*The DeviceIdentifierWrapper library is being replaced by the ZebraOEMInfoWrapper*
=========================================================
*It is available here : https://github.com/ltrudu/ZebraOEMInfoWrapper*
=========================================================
 * The new library gives access to: device info, WAN info, Software info, OS update info.
 *
 *
 *
 *
